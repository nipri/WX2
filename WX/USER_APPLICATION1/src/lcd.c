...
static void lcd_write(uint8_t data,uint8_t rs)
  ...
  if ( ( &LCD_DATA0_PORT == &LCD_DATA1_PORT) && ( &LCD_DATA1_PORT == &LCD_DATA2_PORT ) && ( &LCD_DATA2_PORT == &LCD_DATA3_PORT )
    ...
    {
      if ( ( &LCD_DATA0_PORT == &LCD_DATA1_PORT) && ( &LCD_DATA1_PORT == &LCD_DATA2_PORT ) && ( &LCD_DATA2_PORT == &LCD_DATA3_PORT )
         && (LCD_DATA0_PIN == 4) && (LCD_DATA1_PIN == 5) && (LCD_DATA2_PIN == 6) && (LCD_DATA3_PIN == 7) )
      {
      /* configure data pins as output */
...
static uint8_t lcd_read(uint8_t rs)
  ...
  if ( ( &LCD_DATA0_PORT == &LCD_DATA1_PORT) && ( &LCD_DATA1_PORT == &LCD_DATA2_PORT ) && ( &LCD_DATA2_PORT == &LCD_DATA3_PORT )
    ...
    if ( ( &LCD_DATA0_PORT == &LCD_DATA1_PORT) && ( &LCD_DATA1_PORT == &LCD_DATA2_PORT ) && ( &LCD_DATA2_PORT == &LCD_DATA3_PORT )
         && ( LCD_DATA0_PIN == 4 )&& (LCD_DATA1_PIN == 5) && (LCD_DATA2_PIN == 6) && (LCD_DATA3_PIN == 7) )
      {
      DDR(LCD_DATA0_PORT) &= 0x0f;         /* configure data pins as input */
      ...
      lcd_e_high();
      lcd_e_delay();
      data |= (PIN(LCD_DATA0_PORT)>>4)&0x0f;    /* read low nibble        */
      lcd_e_low();
      }
    else
      {
...
static inline void lcd_newline(uint8_t pos)
  ...
  if ( pos < LCD_START_LINE2 )
    ...
    if ( (pos >= LCD_START_LINE2) && (pos < LCD_START_LINE3) )
      {
      addressCounter = LCD_START_LINE3;
      }
    else
      if ( (pos >= LCD_START_LINE3) && (pos < LCD_START_LINE4) )
        {
  ...
  if ( pos < LCD_START_LINE3 )
    ...
    if ( (pos >= LCD_START_LINE2) && (pos < LCD_START_LINE4) )
      {
      addressCounter = LCD_START_LINE3;
      }
    else
      if ( (pos >= LCD_START_LINE3) && (pos < LCD_START_LINE2) )
        {
        addressCounter = LCD_START_LINE4;
        }
      else
...
void lcd_putc(char c)
  ...
  if (c=='\n')
    ...
    if ( pos == LCD_START_LINE1+LCD_DISP_LENGTH )
      ...
      if ( pos == LCD_START_LINE2+LCD_DISP_LENGTH )
        {
        lcd_write((1<<LCD_DDRAM)+LCD_START_LINE1,0);
        }
#elif LCD_LINES==4
    if ( pos == LCD_START_LINE1+LCD_DISP_LENGTH )
      ...
      if ( pos == LCD_START_LINE2+LCD_DISP_LENGTH )
        ...
        if ( pos == LCD_START_LINE3+LCD_DISP_LENGTH )
          {
          lcd_write((1<<LCD_DDRAM)+LCD_START_LINE4,0);
          }
        else
          if ( pos == LCD_START_LINE4+LCD_DISP_LENGTH )
            {
            lcd_write((1<<LCD_DDRAM)+LCD_START_LINE1,0);
            }
#endif
